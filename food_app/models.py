...
class RecommendationHistory(models.Model):
    ...
    selected_food = models.ForeignKey(FoodItem, related_name='selected_food', on_delete=models.CASCADE)
    recommended_food_1 = models.ForeignKey(FoodItem, related_name='recommended_food_1', on_delete=models.CASCADE)
    recommended_food_2 = models.ForeignKey(FoodItem, related_name='recommended_food_2', on_delete=models.CASCADE)
    recommended_food_3 = models.ForeignKey(FoodItem, related_name='recommended_food_3', on_delete=models.CASCADE)
